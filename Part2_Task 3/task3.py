...
def check_data_file():
    ...
    possible_paths = [
        'issue_priority_dataset.csv',  # Same directory as script
        'Task 3/issue_priority_dataset.csv',  # Task 3 subdirectory
        './Task 3/issue_priority_dataset.csv',  # Relative path
        os.path.join(os.path.dirname(__file__), 'issue_priority_dataset.csv')  # Script directory
    ]
    ...
    if data_file is None:
        print("Error: Data file 'issue_priority_dataset.csv' not found!")
        print("Searched in the following locations:")
        for path in possible_paths:
            print(f"  - {path}")
        print("Please ensure the CSV file is in one of these locations.")
        return False
